package com.KysonnDelaCerna.Bruh.items;
...
public class ItemChannBoat extends ItemBoat implements IHasModel {
	public ItemChannBoat (String name) {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityBoat entityboat = new EntityChannBoat(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
